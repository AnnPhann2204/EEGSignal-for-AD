...
import sklearn, scikitplot, scipy, os
...
save_dir_image = '/home/annphan/PycharmProjects/EEG-AD/image'

# Create the directory if it doesn't exist
os.makedirs(save_dir_image, exist_ok=True)

# Section 2: Dataset Preparation
df_HCvMCI = pd.read_csv('/home/annphan/PycharmProjects/EEG-AD/data/MCIvsHCFourier.csv')
df_MCIvAD = pd.read_csv('/home/annphan/PycharmProjects/EEG-AD/data/MCIvsADFourier.csv')
df_ADvHC = pd.read_csv('/home/annphan/PycharmProjects/EEG-AD/data/ADvsHCFourier.csv')
...
# plt.show()
#
# accuracy = (RVC_y_pred_labels == RYTestHvM).mean() * 100.
# print("RVC classification HC and MCI accuracy : %g%%" % accuracy)
...
# plt.savefig(os.path.join(save_dir_image,'confusion_matrix_HCandMCI_RLR.png'))
# plt.show()
#
...
# plt.savefig(os.path.join(save_dir_image,'confusion_matrix_ADandMCI_RLR.png'))
#
...
# plt.savefig(os.path.join(save_dir_image,'confusion_matrix_ADandHC_RLR.png'))
# 
# accuracy = (RLRTestPred2 == YTestRLRAvH).mean() * 100.
# print("RLR classification for AD and HC accuracy : %g%%" % accuracy) #57.1429%
...
# print("RF classification for AD and HC accuracy : %g%%" % accuracy) #57.1429%
